                        ...
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                ...
                                <li class="nav-item">
                                    ...
                                    <i class="fa-solid fa-fire-flame-curved"></i> <span class="ms-1 d-none d-sm-inline text-white p-2">إضافة قسم التذكرة</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('additem')}}" class="nav-link px-0 align-middle">
                                    <i class="fa-solid fa-ticket"></i><span class="ms-1 d-none d-sm-inline text-white p-2"> حجز تذكرة</span></a>
                                </li>
                                <li>
                                    <a href="#submenu2" data-bs-toggle="collapse" class="nav-link px-0 align-middle ">
                                    <i class="fa-solid fa-receipt"></i> <span class="ms-1 d-none d-sm-inline text-white p-2">الفواتير</span></a>
                            ...
                            <div class="dropdown pb-4">
                                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="/images/onep.png" alt="hugenerd" width="30" height="30" class="rounded-circle">
                                    <span class="d-none d-sm-inline mx-1">Areej</span>
                                </a>
